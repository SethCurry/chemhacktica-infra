...
from ..transport import NpipeHTTPAdapter as NpipeHTTPAdapter, SSHHTTPAdapter as SSHHTTPAdapter, UnixHTTPAdapter as UnixHTTPAdapter
...
class APIClient(requests.Session, BuildApiMixin, ConfigApiMixin, ContainerApiMixin, DaemonApiMixin, ExecApiMixin, ImageApiMixin, NetworkApiMixin, PluginApiMixin, SecretApiMixin, ServiceApiMixin, SwarmApiMixin, VolumeApiMixin):
    ...
    def __init__(self, base_url=None, version=None, timeout=..., tls: bool = False, user_agent=..., num_pools=None, credstore_env=None, use_ssh_client: bool = False, max_pool_size=...) -> None: ...
