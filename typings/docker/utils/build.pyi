...
def tar(path, exclude=None, dockerfile=None, fileobj=None, gzip: bool = False): ...
def exclude_paths(root, patterns, dockerfile=None): ...
def build_file_list(root): ...
def create_archive(root, files=None, fileobj=None, gzip: bool = False, extra_files=None): ...
